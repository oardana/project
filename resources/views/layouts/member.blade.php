...
<div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-4 bg-gray-200 h-[100vh]">
    <h1 class="text-3xl text-center pb-5"> Data Member</h1>
  ...
  @endif
    <a href="/member/create" type="submit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Add Data</a>
    @if($members->isEmpty())
    <h1 class="text-3xl text-center pb-5">Data Not Found.....</h1>
    @else
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10 pb-100">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="flex items-center px-6 py-4">
                        <a href="/member/{{$item->id}}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
