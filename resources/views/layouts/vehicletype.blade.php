...
<div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-4 bg-gray-200 h-[100vh]">
    ...
    <a href="/vehicletype/create" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Add Item</a>
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    <th scope="col" class="p-4">No</th>
                     <th scope="col" class="px-6 py-3">Name Type</th>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="flex items-center px-6 py-4">
                        <a href="/vehicletype/{{$item->id}}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
