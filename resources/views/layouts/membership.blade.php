...
<div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-4 bg-gray-200 h-[100vh]"> 
    ...
    <a href="/membership/create" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Add Item</a>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">{{$item->name_member}}</td>
                            <td class="px-6 py-4">{{$item->created_at}}</td>
                            <td class="px-6 py-4">{{$item->updated_at}}</td>
                            <td class="flex items-center px-6 py-4">
                                <a href="/membership/{{$item->id}}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
